...
Set `annotated = TRUE` to switch the legend title to "Cell Type" and sort
...
Pass a character vector to `specific_clusters` to draw a subset of cells on top
