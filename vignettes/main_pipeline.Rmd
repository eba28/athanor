...
* `stage = "reduced"` means that GEX PCs are concatenated with BCR embeddings
* `stage = "embed"` means that GEX PCs are concatenated with BCR PCs
...
* `stage = "reduced"` means that GEX PCs are concatenated with BCR features
* `stage = "embed"` means that GEX PCs are concatenated with BCR PCs
...
# keep a copy so run_wnn() below starts from the same object
obj_cat <- concatenate_gex_bcr(seurat_obj = obj, stage = "reduced",
                               cols_to_include =
